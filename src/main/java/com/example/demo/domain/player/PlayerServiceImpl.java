...
public class PlayerServiceImpl implements PlayerService {
    ...
    @Override
    public AbstractMap.SimpleEntry<Revision, Player> addPlayer(Integer gameId, Revision revision) throws GameNotFoundFoundException, RevisionsDontMatchException {
